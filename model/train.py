...
if __name__ == "__main__":
    ...
    train_dataset = datasets.MNIST(root='model/data', train=True, download=True, transform=train_transform)
    val_dataset = datasets.MNIST(root='model/data', train=False, download=True, transform=transform)
    test_dataset = datasets.MNIST(root='model/data', train=False, download=True, transform=transform)
    ...
    train(model, total_epochs, train_loader=train_loader, val_loader=val_loader, test_loader=test_loader, loss_func=nn.CrossEntropyLoss(label_smoothing=0.1), optimizer=optimizer, scheduler=scheduler)